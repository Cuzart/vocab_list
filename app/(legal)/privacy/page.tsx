        ...
        <Container py={30}>
          ...
          <div className='wrapper'>
            ...
            <p>
              ...
              <Link href='/privacy#hinweis-zur-verantwortlichen-stelle'>
            ...
            {config.cloudflare && (
              <>
                ...
                <p>
                  ...
                  Website &uuml;ber das Netzwerk von Cloudflare geleitet. Das versetzt Cloudflare in
                  die Lage, den Datenverkehr zwischen Ihrem Browser und unserer Website zu
                  analysieren und als Filter zwischen unseren Servern und potenziell b&ouml;sartigem
                  Datenverkehr aus dem Internet zu dienen. Hierbei kann Cloudflare auch Cookies oder
                  sonstige Technologien zur Wiedererkennung von Internetnutzern einsetzen, die
                ...
                <p>
                  ...
                  m&ouml;glichst fehlerfreien und sicheren Bereitstellung unseres Webangebotes (Art.
                  6 Abs. 1 lit. f DSGVO).
                </p>
                <p>
                ...
                <p>
                  Weitere Informationen zum Thema Sicherheit und Datenschutz bei Cloudflare finden
                  Sie hier:
                  <a
                    href='https://www.cloudflare.com/privacypolicy/'
                    target='_blank'
            ...
            <p>
              ...
              zus&auml;tzlich auf Grundlage von &sect; 25 Abs. 1 TDDSG. Die Einwilligung ist
            ...
            <p>
              ...
              Interesse nach Art. 6 Abs. 1 lit. f DSGVO an der Weitergabe haben oder wenn eine
              ...
              eines g&uuml;ltigen Vertrags &uuml;ber Auftragsverarbeitung weiter. Im Falle einer
              gemeinsamen Verarbeitung wird ein Vertrag &uuml;ber gemeinsame Verarbeitung
              geschlossen.
            </p>
              ...
              <>
                ...
                {config.brevo && (
                  <p>
                    ...
                    Gründen die Email des Absenders an den Anbieter übermittelt. Die
                    Absenderadressen werden auf den Servern des Anbieters für den Zeitraum von einen
                    Monat gespeichert und anschließend gelöscht. Der Inhalt der Kontaktanfrage wird
                    dabei nicht beim Anbieter mitgespeichert.{' '}
            ...
            {config.umami && (
              <>
                ...
                <p>
                  ...
                  erteilt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6
                  Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDDG, soweit die Einwilligung die Speicherung
                ...
                <h4>Hosting</h4>{' '}
                <p>
                  Hosting Wir betreiben Umami ausschließlich auf unseren eigenen Servern, sodass
                  alle Analysedaten bei uns verbleiben und nicht an Dritte weitergeleitet werden.
                  Dies garantiert, dass die Datenverarbeitung in einer sicheren und kontrollierten
            ...
            {config.auth && (
              <>
                ...
                <p>
                  ...
                  Funktionen auf der Seite zu nutzen. Die dazu eingegebenen Daten verwenden wir nur
                  zum Zwecke der Nutzung des jeweiligen Angebotes oder Dienstes, f&uuml;r den Sie
                  sich registriert haben. Die bei der Registrierung abgefragten Pflichtangaben
                  m&uuml;ssen vollst&auml;ndig angegeben werden. Anderenfalls werden wir die
                ...
                <p>
                  ...
                  der Durchf&uuml;hrung des durch die Registrierung begr&uuml;ndeten
                ...
                <p>
                  ...
                  Daten verwenden wir Supabase auf Grundlage des Art. 6 Abs. 1 lit. b) DSGVO.
                  Supabase ist ein DGSVO-konformer Dienst für Cloud-Datenbanken und Backend-Lösungen
                  mit Hauptsitz in 970 Toa Payoh North #07-04, Singapore 318992.
                </p>
                <p>
                  Wir haben einen Vertrag &uuml;ber Auftragsverarbeitung (AVV) zur Nutzung des oben
                  genannten Dienstes geschlossen. Hierbei handelt es sich um einen
            ...
            {config.youtube && (
              <>
                ...
                <p>
                  Wenn Sie eine dieser Website besuchen, auf denen YouTube eingebunden ist, wird
                  ...
                  Surfverhalten direkt Ihrem pers&ouml;nlichen Profil zuzuordnen. Dies k&ouml;nnen
                ...
                <p>
                  ...
                  &auml;hnlich wie Cookies personenbezogene Daten beinhalten und zur Wiedererkennung
                  eingesetzt werden k&ouml;nnen. Details zum erweiterten Datenschutzmodus finden Sie
                  hier:
                  <a
                ...
                <p>
                  ...
                  erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit.
                  a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von
