...
export const rotate: MantineTransition = {
  in: { opacity: 1, transform: 'translate(-50%, -50%) rotate(-180deg)' },
...
export const rotateReverted: MantineTransition = {
  in: { opacity: 1, transform: 'translate(-50%, -50%) rotate(0deg)' },
  out: { opacity: 0, transform: 'translate(-50%, -50%) rotate(180deg)' },
  common: { position: 'absolute', top: '50%', left: '50%' },
  transitionProperty: 'transform, opacity',
};
